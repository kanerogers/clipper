...
/// Once you create a [`crate::LazyVulkan`] instance, you **must** use the same handles each time you call a
...
pub struct VulkanContext {
    ...
    /// Memory properties used for [`crate::LazyVulkan`]'s allocation commands
